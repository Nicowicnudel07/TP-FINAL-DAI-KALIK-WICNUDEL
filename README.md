...
La navegación está resuelta con React Navigation y organiza la experiencia en pantallas de registro, perfil y ubicación.
...
5. Mostrar las tabs de Perfil (datos guardados con foto) y Ubicación (coordenadas + distancia al punto de referencia).

## Próximos pasos recomendados

- Persistir los datos de registro con `AsyncStorage` para mantener la sesión.
- Incorporar un mapa interactivo para visualizar la posición y los puntos de referencia.
